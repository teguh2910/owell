...
<head>
    ...
    <title>Input Kebutuhan Bulanan PPIC</title>
    <style>
...
<body>
    <h1>Input Kebutuhan Bulanan PPIC</h1>
    ...
    <form action="{{ route('monthly_requirements.store') }}" method="POST">
        @csrf
        <div>
        ...
        <div>
            ...
            <input type="number" id="year" name="year" value="{{ old('year', $currentYear) }}" min="{{ date('Y') }}" required>
        </div>
        <div>
        ...
        <div>
            ...
            <input type="number" id="total_monthly_usage" name="total_monthly_usage" value="{{ old('total_monthly_usage') }}" min="1" required>
        </div>
